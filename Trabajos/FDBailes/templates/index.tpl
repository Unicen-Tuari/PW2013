        ...
        <div class="form-group" id="form_dni">
          <div class="input-group col-lg-12">
           ...
           <span class="input-group-btn">
              <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-ok"></button>
           </span>
          </div>
        </div>
    </form>
             ...
             <form class="form-horizontal">
               <div class="form-group">
                ...
                <div class="input-group col-lg-12">
                 ...
                 <span class="help-block">Todos los campos son Obligatorios.</span>
                 <br>
                 <button class="btn btn-danger col-lg-1 col-lg-offset-4" type="reset"><span class="glyphicon glyphicon-remove"></button>
