<?php /* Smarty version Smarty-3.1.14, created on 2013-10-08 20:21:00
...
?>
                <li class="active" style="text-transform: capitalize;"><a href="#"><?php echo $_smarty_tpl->tpl_vars['marca']->value['nombre'];?>
</a></li>  
                 <?php } ?>                            
              </ul>
            </div><!--/.well -->
