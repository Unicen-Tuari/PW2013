...
function consulta_comentarios_admin($IDPost,$pagina){
...
print ("
	<div class='datbox-comentarios'>
		<div class='descrip'><!--Description of the post-->
			#$consulta[ID] $consulta[Username] el $dia de $nom_mes del $fecha[0] a las $hora[0]:$hora[1] comento: <br>
			$consulta[texto]
		</div>
		<form action='eliminar_comen.php' method='POST'>
			<input type='hidden' name=idcomen id=idcomen value=$consulta[ID]>
			<input type='hidden' name=idpost id=idpost value=$consulta[IDPost]>
			<input type='hidden' name=username id=username value=$consulta[Username]>
			<button type='submit' class='go-post'>Eliminar</button>	
		</form>
	</div>");}
if (($siguiente == $limite) AND ($limite < mysql_num_rows($query_comen)))  {
	$pagina ++;
	print ("<a href='index.php?type=P&idpost=$IDPost&paginacomen=$pagina'><button class='siguiente'>Mas comentarios</button></a>
	");}
...
<form class='nuevo-post' name='nuevocomen' id='nuevocomen' method='POST' align='center' action='comentar.php'>
	...
	<div class='datbox-post' ><textarea class='texto' name='comentario' id='comentario' font-size:11px; placeholder='Añade un comentario..'></textarea><br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 31)) { echo "Debe ingresar un texto entre 5 y 250 carteres.";} print("
	</div><button type='submit' class='go-post'>Comentar</button></form>");
...
$limite = 10*$pagina;
$limite ++;
$sql = "SELECT p.ID, p.IDCategoria, c.nombre, p.IDUsuario, u.Username,p.valido, p.Fecha, p.Titulo
		FROM posts p
		JOIN usuarios u ON ( u.ID = p.IDUsuario ) 
		JOIN categorias c ON ( c.ID = p.IDCategoria )
	...
	<div class='post'>
		...
		<div class='datbox'>
			...
			print("</div>
				...
				<input type='hidden' name=iduser id=iduser value=$consulta[IDUsuario]>
				<button type='submit' class='eliminar'>Eliminar</button>	
				</form>
				<form action='index.php' method='POST'>
				<input type='hidden' name='idpost' id='idpost' value=$consulta[ID]>
				<input type='hidden' name='admin' id='admin' value='edit'>
				<button type='submit' class='go-post'>Editar</button></a>
				</form>
		</div>
	</div>
");consulta_comentarios_admin($IDPost,$paginacomen);
} else {
$consulta['descripcion'] = nl2br($consulta['descripcion'], false);	
print ("
	<div class='post'>
...
print("<form class='nuevo-post' name='nuevovid' id='nuevovid' method='POST' align='center'  action='editar.php'>
			...
			<div class='datbox-post' ><div class='legend-descarga'>Sinopsis</div><textarea class='texto' onkeyup='CargarPreviewSinopsis(this)' name='sinopsis' id='sinopsis' >".$consulta['sinopsis']."</textarea><br>"); if ((isset($_GET['error'])) AND (($_GET['error'] == 13) OR ($_GET['error'] == 17))){ echo "Debe ingresar una sinopsis de 150 a 500 caracteres.";} print("</div>
			<div class='datbox-post' ><div class='legend-post'>Trailer</div><input type='text' class='renglon' onkeyup='CargarPreviewTrailer(this)' id='trailer' name='trailer' id='trailer' value=".$consulta['trailer']."><br>"); if ((isset($_GET['error'])) AND (($_GET['error'] == 14) OR ($_GET['error'] == 18))){ echo "Debe ingresar un url a un video.";} print("</div>
...
print("<form class='nuevo-post' name='nuevojuego' id='nuevojuego' method='POST' align='center'  action='editar.php'>
			...
			<div class='datbox-post' ><div class='legend-descripcion'>Descripcion</div><textarea class='texto' name='descripcion' onkeyup='CargarPreviewDescripcion(this)' id='descripcion'>".$consulta['descripcion']." </textarea><br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 22)){ echo "Debe ingresar una descripcion de 150 a 3000 caracteres.";} print("</div>
			...
			<div class='datbox-post' ><div class='legend-post'>Trailer</div><input type='text' class='renglon' name='trailer' onkeyup='CargarPreviewTrailer(this)' id='trailer' value=".$consulta['trailer']."> <br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 29)){ echo "Debe ingresar un url a un video.";} print("</div>
...
print("<form class='nuevo-post' name='nuevovid' id='nuevovid' method='POST' align='center' action='postear.php'>
			...
			<div class='datbox-post' ><div class='legend-descarga'>Sinopsis</div><textarea class='texto' name='sinopsis' id='sinopsis' onkeyup='CargarPreviewSinopsis(this)' font-size:11px; placeholder='...Sinopsis (minimo 50 caracteres)...'></textarea><br>"); if ((isset($_GET['error'])) AND (($_GET['error'] == 13) OR ($_GET['error'] == 17))){ echo "Debe ingresar una sinopsis de 150 a 500 caracteres.";} print("</div>
			<div class='datbox-post' ><div class='legend-post'>Trailer</div><input type='text' class='renglon' name='trailer' onkeyup='CargarPreviewTrailer(document.nuevovid.trailer)' id='trailer' placeholder='Atencion! Subir video como: http://www.youtube.com/v/ID_VIDEO '/><br>"); if ((isset($_GET['error'])) AND (($_GET['error'] == 14) OR ($_GET['error'] == 18))){ echo "Debe ingresar un url a un video.";} print("</div>
			<div class='datbox-post'><div class='legend-descarga'>Descarga</div>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 15)) { echo "Debe ingresar al menos 3 enlaces completos";} print("
...
print("<form class='nuevo-post' name='nuevojuego' id='nuevojuego' method='POST' align='center'  action='postear.php'>
			<div class='datbox-post' ><div class='legend-post'>Titulo</div><input type='text' class='renglon' name='titulo' id='titulo' onkeyup='CargarPreviewTitulo(document.nuevojuego.titulo)' onBlur='verifica(document.nuevojuego.titulo,5,50)' placeholder='...Titulo...'/><br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 20)){ echo "Debe ingresar un titulo correcto, entre 5 y 70 caracteres.";} print("</div>
			...
			<div class='datbox-post' ><div class='legend-descripcion'>Descripcion</div><textarea class='texto' name='descripcion' onkeyup='CargarPreviewDescripcion(document.nuevojuego.descripcion)' id='descripcion' placeholder='...Descripcion (minimo 50 caracteres)...'></textarea><br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 22)){ echo "Debe ingresar una descripcion de 150 a 3000 caracteres.";} print("</div>
			<div class='datbox-post' ><div class='legend-requirimientos-post'>Requirimientos Minimos</div>
			...
			<div class='datbox-post' ><div class='legend-post'>Trailer</div><input type='text' class='renglon' name='trailer' onkeyup='CargarPreviewTrailer(this)' id='trailer' placeholder='Atencion! Subir video como: http://www.youtube.com/v/ID_VIDEO'/><br>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 29)){ echo "Debe ingresar un url a un video.";} print("</div>
			<div class='datbox-post'><div class='legend-descarga'>Descarga</div>"); if ((isset($_GET['error'])) AND ($_GET['error'] == 30)) { echo "Debe ingresar al menos 3 enlaces completos";} print("
		...
		<div>
			<div class='datbox-title'>
				<div class='title'>
					<div id='dateblock'>$mes<div id='day'>$dia</div></div>
					<div id='post-title'><span id='PreviewTitulo'></span></div>
					<div id='post-details'>Posteado En: Juegos por $usuario	</div>
				</div>
			</div>
			<div class='datbox' align='center'>
			<img class='imagen' id='PreviewImagen' >
...
function consulta_principal_admin(){
	...
	<div class='post'>
		<div class='datbox-title'><!--Box with date and title-->
			<div class='title'>
				<div id='dateblock'>$mes<div id='day'>$dia</div></div>
				<div id='post-title'>$consulta[Titulo]</div>
				<div id='post-details'>	Posteado En: $consulta[nombre] por #$consulta[IDUsuario] $consulta[Username]	</div>
			</div>
		</div>
		<div class='datbox' align='center'><!--Image of the post-->
		<img class='imagen' src=$consulta[url_imagen]>
		...
		"); if ($consulta['trailer'] <> NULL){print("
		<div class='datbox'>
			<div class='legend-descripcion'> Trailer</div>
			<div class='descrip'><!--Description of the post-->
			<center><embed width='420' height='315' src='$consulta[trailer]' frameborder='0' type='application/x-shockwave-flash' allowfullscreen></embed></center></div>
		...
		<div class='datbox'>
			...
			if (($consulta['enlace40']<> NULL) AND ($consulta['urldescarga40']<> NULL)){ print("<center><a href = '$consulta[urldescarga40]'> $consulta[enlace40]</center>  </a>");}
			print("</div>
				<form action='validar.php' method='POST' target='_self'>
				<input type='hidden' name=idpost id=idpost value=$consulta[ID]>
				<input type='hidden' name=iduser id=iduser value=$consulta[IDUsuario]>
				<button type='submit' class='go-post'>Validar</button></a>
				</form>
				<form action='eliminar.php' method='POST' target='_self'>
				<input type='hidden' name=idpost id=idpost value=$consulta[ID]>
				<input type='hidden' name=iduser id=iduser value=$consulta[IDUsuario]>
				<button type='submit' class='eliminar'>Eliminar</button></a>
				</form>
				<form action='index.php' method='POST' >
				<input type='hidden' name='idpost' id='idpost' value=$consulta[ID]>
				<input type='hidden' name='admin' id='admin' value='edit'>
