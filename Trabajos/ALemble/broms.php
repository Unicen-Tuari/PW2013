		...
		<div class="content">
			<div class="post">
				...
				<div class="datbox"><!--Info of the post-->
					<div class="info">
						...
						<b>REPARTO:</b> <br>
						<b>GÉNERO:</b> <br>
						<b>FECHA DE ESTRENO CANADÁ:</b> <br>
						<b>FECHA DE ESTRENO USA:</b> <br>
						<b>FECHA DE ESTRENO MÉXICO:</b> <br>
						<b>FECHA DE ESTRENO ESPAÑA:</b> <br>
					</div>
				</div>
				<div class="datbox">
					<div class="tec"><!--Tecnical dates of the post-->
					<b>Star Wars Saga (1978-2013)</b><br>
					BDRip 720p | XviD | x264 | AC3 5.1 | DTS | 3.1 GB | 4.1 GB | Audios: Español Latino, Inglés | Subtítulos: Español, Inglés | Ciencia-Ficcion | 2013 | NFO 
					</div>
				</div>
				<div class="datbox">
			...
			<div class="post">
				<div class="datbox"><!--Box with date and title-->
					<div class="title">
						<div id="dateblock">	Abril	<div id="day">	25	</div>	</div>
						<div id="post-title">	Evangelion 3.33 You Can (Not) Redo (2012) 720p BDRip Subtítulos Español	</div>
						<div id="post-details">	Posteado En: Broms, Peliculas por Blackjak	</div>
					</div>
				</div>
				...
				<div class="datbox"><!--Info of the post-->
					<div class="info">
						<b>TÍTULO ORIGINAL: Evangelion: 3.0 You Can (Not) Redo (Evangelion 3.0: Q Quickening)</b> <br>
						<b>AÑO: 2012</b> <br>
						<b>DURACIÓN: 96 min.</b> <br>
						<b>PAÍS: Japón</b> <br>
						<b>DIRECTOR: Hideaki Anno</b> <br>
						<b>GUIÓN: Hideaki Anno</b> <br>
						<b>MÚSICA: Shiro Sagisu</b> <br>
						<b>FOTOGRAFÍA: Animation</b> <br>
						<b>GÉNERO:Animación. Ciencia ficción. Drama. Acción | Remake. Secuela. Robots</b> <br>
						</div>
				</div>
				<div class="datbox">
					<div class="tec"><!--Tecnical dates of the post-->
					<b>Evangelion 3.33 You Can (Not) Redo (2012)</b><br>
					BDRip 720p | XviD | x264 | AC3 5.1 | 2.1 GB | 3.2 GB | Audio: Japonés | Subtítulos: Español | Animación | 2012 | NFO					</div>
				</div>
				<div class="datbox">
					<div class="descrip"><!--Description of the post-->
					Evangelion 3.0 es la tercera entrega de la tetralogía “Rebuild Of Evangelion” y los capítulos que re-adaptaran a la pantalla grande seran desde el 20 al 24 en el cual los sucesos más transcendentes van desde la operación de rescate de Shinji y Rei quienes se encuentran absorbidos dentro del EVA unidad 01, la pelea espacial que se da entre el décimo ángel Arael y el EVA unidad 02 piloteado nuevamente por Asuka y el ataque del ultimo ángel Kaworu Nagisa al dogma central de Nerv con su propio EVA unidad 06.					</div>
			...
			<div class="post">
				<div class="datbox"><!--Box with date and title-->
					<div class="title">
						...
						<div id="post-title">	Mama (2013) 720p BDRip Dual Español Latino-Inglés</div>
						<div id="post-details">	Posteado En: Broms, Peliculas por Blackjak	</div>
					</div>
				</div>
				...
				<div class="datbox"><!--Info of the post-->
					<div class="info">
						<b>TÍTULO ORIGINAL: Mama</b> <br>
						<b>OTROS TÍTULOS: Mamá</b> <br>
						<b>AÑO: 2013</b> <br>
						<b>DURACIÓN: 100 min.</b> <br>
						<b>PAÍS: Canadá</b> <br>
						<b>DIRECTOR: Andrés Muschietti</b> <br>
						<b>GUIÓN: Andrés Muschietti, Neil Cross, Barbara Muschietti (Historia: Andrés Muschietti, Barbara muschietti)</b> <br>
						<b>MÚSICA: Fernando Velázquez</b> <br>
						<b>FOTOGRAFÍA: Antonio Riestra</b> <br>
						...
						<b>GÉNERO: Terror. Thriller | Sobrenatural. Fantasmas</b> <br>
						<b>FECHA DE ESTRENO CANADÁ:	18 de enero de 2013</b> <br>
						<b>FECHA DE ESTRENO USA:	18 de enero de 2013</b> <br>
						<b>FECHA DE ESTRENO MÉXICO: 1 de febrero de 2013</b> <br>
						<b>FECHA DE ESTRENO ESPAÑA: 8 de febrero de 2013</b> <br>
					</div>
				</div>
				...
				<div class="datbox">
					<div class="tec"><!--Tecnical dates of the post-->
					<b>Mama (2013) </b><br>
					BDRip 720p | XviD | x264 | AC3 5.1 | DTS | 3.1 GB | 4.1 GB | Audios: Español Latino, Inglés | Subtítulos: Español, Inglés | Terror | 2013 | NFO 					</div>
				</div>
				<div class="datbox">
					<div class="descrip"><!--Description of the post-->
