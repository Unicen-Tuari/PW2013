...
<html>
	...
	<body>
		...
		<nav><!--Search box-->
			<a href='categoria.php?categoria=peliculas'><button type="button" id="search-button-movie">PELICULAS</button></a>
			<a href='categoria.php?categoria=series'><button type="button" id="search-button-serie">SERIES</button></a>
			<a href='categoria.php?categoria=juegos'><button type="button" id="search-button-game">JUEGOS</button></a>
		</nav>
		...
		<div class='content'>
			<div class='post'>
				...
				<div class='datbox'>
					...
					<a href='post_unico.php?numero=$num_fila'><button type='button' class='go-post'>Ir al post</button></a>
				</div>
			</div>
		</div>
		");} ?>
